...
if [[ -z "$THEME" ]]; then
    ...
    echo "  ╠══════════════════════════════════════════╣"
    echo "  ║  0 = VFD (Cyan)             ██ bitmap   ║"
    echo "  ║  1 = LCD (Cyan)             ██ segment  ║"
    echo "  ║  2 = LCD (Fósforo Verde)    ██ segment  ║"
    echo "  ║  3 = LCD (Ámbar)            ██ segment  ║"
    echo "  ║  4 = LCD (Blanco)           ██ segment  ║"
    echo "  ║  5 = LCD (Azul Siemens)     ██ segment  ║"
