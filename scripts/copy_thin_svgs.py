...
source_dir = "/Users/z0051syf/Temp/phosphor-icons/SVGs/thin/"
dest_dir = "resources/drawables/"

mapping = {
    "icon_steps.svg": "sneaker-thin.svg",
    "icon_distance.svg": "map-pin-thin.svg",
    "icon_calories.svg": "fire-thin.svg",
    "icon_floors.svg": "stairs-thin.svg"
}
...
for dest_name, src_name in mapping.items():
    ...
    if os.path.exists(src_path):
        ...
        # Add width and height to SVG tag specifically
        # Phosphor has <svg xmlns="..." viewBox="...">
        # We will strip any existing width/height from <svg> just in case, though there shouldn't be
